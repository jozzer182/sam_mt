...
class ConsumoMc {
  ...
  factory ConsumoMc.fromMap(Map<String, dynamic> map) {
    return ConsumoMc(
      id: map['id'].toString(),
  ...
  factory ConsumoMc.fromInit(int index) {
  ...
  factory ConsumoMc.fromJson(String source) =>
      ConsumoMc.fromMap(json.decode(source));
