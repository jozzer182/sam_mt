...
class ConsumoMcPageEdit extends StatefulWidget {
  final bool esNuevo;
  final String pedido;
  final String tecnicoid;
  const ConsumoMcPageEdit({
    super.key,
    this.esNuevo = true,
    this.pedido = '',
    this.tecnicoid = '',
  ...
  @override
  State<ConsumoMcPageEdit> createState() => _ConsumoMcPageEditState();
}

class _ConsumoMcPageEditState extends State<ConsumoMcPageEdit>
  ...
  void initState() {
    ...
    if (widget.esNuevo) {
      context.read<MainBloc>().consumosMcCtrl.crearNuevo;
    } else {
      context.read<MainBloc>().consumosMcCtrl.cargarPedido(widget.pedido);
    }

    if (widget.tecnicoid.isNotEmpty) {
      context.read<MainBloc>().consumosMcCtrl.cambiarEncabezado(
        campo: 'tecnicoid',
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MainBloc, MainState>(
      builder: (context, state) {
        ...
        List<ConsumoMc> listEdit = consumosMcList.listEdit;
        ConsumoMc first =
            listEdit.isNotEmpty ? listEdit.first : ConsumoMc.fromInit(0);
        return Scaffold(
          appBar: AppBar(
            title: Text('CONSUMOS TDC-TICKET'),
            ...
            actions: [
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  bool esvalido =
                      context.read<MainBloc>().consumosMcCtrl.validarCampos();
                  if (esvalido) {
                    showDialog(
                      context: context,
                      builder: (BuildContext context) {
                          ...
                          actions: [
                            ...
                            TextButton(
                              ...
                              onPressed: () {
                                ...
                                context.read<MainBloc>().consumosMcCtrl.enviar;
                              },
                            ),
                          ],
                        );
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  //       //               .toList();
                  //       //       optionsX.sort((a, b) => a.compareTo(b));
                  //       //       optionsX.addAll(optionsY);
                  //       //       optionsX = optionsX.toSet().toList();
                  //       //       optionsX.sort((a, b) => a.compareTo(b));
                  //       //       return optionsX;
                  //       //     },
                  //       //     optionsViewBuilder: (context, onSelected, options) {
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () {
                          context.read<MainBloc>().consumosMcCtrl.agregarfila;
                        },
                      ...
                      ElevatedButton(
                        onPressed: () {
                          context.read<MainBloc>().consumosMcCtrl.eliminarFila;
                        },
                  ...
                  SingleChildScrollView(
                    child: Column(
                      children: [
                        for (ConsumoMc carga in listEdit)
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                const Gap(10),
                                Expanded(flex: 3, child: Text(carga.tecnico)),
                                const Gap(10),
                                Expanded(flex: 1, child: Text(carga.tecnicotype)),
                                const Gap(10),
                                Expanded(
                                  flex: 2,
                                  child: TextFormField(
                                    initialValue: carga.tdc,
